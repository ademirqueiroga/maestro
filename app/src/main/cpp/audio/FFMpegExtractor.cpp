...
int64_t
FFMpegExtractor::decode(AAsset *asset, uint8_t *targetData, AudioProperties targetProperties) {
    {
...
bool FFMpegExtractor::createAVFormatContext(AVIOContext *avioContext,
